...
app.post('/submit-building', async (req, res) => {
  try {
    ...
    const imageResponse = await openai.images.generate ({
      model: "dall-e-3",
      prompt: `A speculative building in Bed-Stuy, Brooklyn in the year ${year}. ${aiDescription}. The building show take inspiration from African, African American, and Caribbean artists like Olalekan Jeyifous, Tabita Rezaire, Dario Calmese and his Black Imagination Work, images from the book Black Futures by Jenna Wortham and Kimberly Drew, the work of Ari Melenciano. The buidlings should seem in situation respective to the address it's associated with. They should look as realistic as possible, not like they're generated by AI. Good examples can be found here: https://bedstuy-2125-virtual-client.onrender.com/about.html `,
      n: 1,
      size: "1024x1024"
    });
